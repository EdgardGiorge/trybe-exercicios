...
function authorBornIn1947() {
  return books.find((book) => book.author.birthYear === 1947).author.name;// escreva aqui o seu código
}
...
function getNamedBook() {
  return books.find((book) => book.name.length === 26).name;// escreva seu código aqui
}
